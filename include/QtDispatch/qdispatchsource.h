...
/**
 ...
 executed.
 */
class Q_DISPATCH_EXPORT QDispatchSourceType
    : public QObject
{
    Q_OBJECT
 ...
 */
class Q_DISPATCH_EXPORT QDispatchSourceTypeIODevice
    : public QDispatchSourceType
{
    Q_OBJECT
...
/**
 ...
 @see QDispatchSourceTypeIODevice
 */
class Q_DISPATCH_EXPORT QDispatchSourceTypeIODeviceRead
    : public QDispatchSourceTypeIODevice
{
    Q_OBJECT
...
/**
 ...
 Deletion of the QIODevice after usage is your own responsibility
 */
class Q_DISPATCH_EXPORT QDispatchSourceTypeIODeviceWrite
    : public QDispatchSourceType
{
    Q_OBJECT
 ...
 */
class Q_DISPATCH_EXPORT QDispatchSourceTypeNetworkManager
    : public QDispatchSourceType
{
    Q_OBJECT
 ...
 */
class Q_DISPATCH_EXPORT QDispatchSource
    : public QObject
{
    Q_OBJECT
