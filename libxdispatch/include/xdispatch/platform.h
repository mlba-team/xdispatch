...
#if _MSC_VER >= 1910
    #define XDISPATCH_COMPILER_MSVC2017 1
    #define XDISPATCH_COMPILER "Visual Studio 2017"
#elif _MSC_VER >= 1600
...
// detect enabled featureset
    ...
    #include <cstddef>
        ...
        #define XDISPATCH_CPP11_MEMORY 1
        #define XDISPATCH_CPP11_FUNCTIONAL 1
    #elif XDISPATCH_STL_LIBCPP && XDISPATCH_CPP11
        #define XDISPATCH_CPP11_TYPE_TRAITS 1
        #define XDISPATCH_CPP11_MEMORY 1
        #define XDISPATCH_CPP11_FUNCTIONAL 1
