...
bool _MainEventLoopHandler::event(QEvent *e){
	if(e->type() != _DispatchEvent::TYPECONSTANT)
		return false;

	// execute the runnable embedded within this event
	static_cast<_DispatchEvent*>(e)->exec();
